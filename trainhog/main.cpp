...
// Size must fit descriptor vector size
Size hogWinSize = Size(40, 72);
Size hogBlockSize = Size(16,16);
Size hogCellSize = Size(8,8);
...
int main(int argc, char** argv) {
    ...
    hog.signedGradient = useSignedGradient;
    hog.winSize = hogWinSize; // Default training images size as used in paper
